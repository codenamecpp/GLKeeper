...
{
    {-TERRAIN_BLOCK_HALF_SIZE * 0.5f, 0.0f, -TERRAIN_BLOCK_HALF_SIZE * 0.5f}, // TOP-LEFT (NW)
    { TERRAIN_BLOCK_HALF_SIZE * 0.5f, 0.0f, -TERRAIN_BLOCK_HALF_SIZE * 0.5f}, // TOP-RIGHT (NE)
    { TERRAIN_BLOCK_HALF_SIZE * 0.5f, 0.0f,  TERRAIN_BLOCK_HALF_SIZE * 0.5f}, // BOTTOM-RIGHT (SE)
    {-TERRAIN_BLOCK_HALF_SIZE * 0.5f, 0.0f,  TERRAIN_BLOCK_HALF_SIZE * 0.5f}, // BOTTOM-LEFT (SW)
};

...
namespace cxx
{
    ...
    inline bool intersects(const aabbox& bboxA, const aabbox& bboxB) 
    {
    ...
    inline bool intersects(const aabbox& bbox, const ray3d& theRay, float& distanceNear, float& distanceFar)
    {
    ...
    inline bool intersects(const bounding_sphere& theSphere, const ray3d& theRay, float& theDistance)
    {

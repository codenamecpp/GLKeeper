...
void AABBTree::DebugRenderNode(DebugRenderer& renderer, TreeNode& treeNode)
{
    ...
    {
        // todo: cull nodes
        renderer.DrawAabb(treeNode.mBoundingBox, Color32_Green, true);
        return;
    }
...
void AABBTree::InsertObject(Renderable* entity)
{
    debug_assert(entity);
...
void AABBTree::RemoveObject(Renderable* entity)
{
    debug_assert(entity);
...
void AABBTree::UpdateObject(Renderable* entity)
{
    debug_assert(entity);
    entity->ComputeTransformation();
